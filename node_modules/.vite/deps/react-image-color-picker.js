...
// node_modules/react-image-color-picker/dist/index.esm.js
var import_react2 = __toESM(require_react());

// node_modules/react-image-color-picker/node_modules/tslib/tslib.es6.mjs
...
// node_modules/react-image-color-picker/node_modules/@emotion/memoize/dist/emotion-memoize.esm.js
function memoize(fn) {
...
// node_modules/react-image-color-picker/node_modules/@emotion/is-prop-valid/dist/emotion-is-prop-valid.esm.js
...
// node_modules/react-image-color-picker/node_modules/styled-components/dist/styled-components.browser.esm.js
...
function ruleset(value, root, parent, index, offset, rules, points, type, props, children, length2, siblings) {
  ...
  for (var i3 = 0, j2 = 0, k2 = 0; i3 < index; ++i3)
    for (var x3 = 0, y3 = substr(value, post + 1, post = abs(j2 = points[i3])), z2 = value; x3 < size; ++x3)
...
var P = function(t2, n2) {
  if (true) {
    var o2 = n2 ? ' with the id of "'.concat(n2, '"') : "", s3 = "The component ".concat(t2).concat(o2, " has been created dynamically.\n") + "You may see this warning because you've called styled inside another component.\nTo resolve this only create new StyledComponents outside of any render method and function component.\nSee https://styled-components.com/docs/basics#define-styled-components-outside-of-the-render-method for more info.\n", i3 = console.error;
    try {
      var a3 = true;
...
function de() {
  for (var e2 = [], t2 = 0; t2 < arguments.length; t2++)
    e2[t2] = arguments[t2];
  for (var n2 = e2[0], o2 = [], r3 = 1, s3 = e2.length; r3 < s3; r3 += 1)
    o2.push(e2[r3]);
...
var fe = function() {
  ...
  return e2.prototype.indexOfGroup = function(e3) {
    ...
    if (e3 >= this.groupSizes.length) {
      for (var n2 = this.groupSizes, o2 = n2.length, r3 = o2; e3 >= r3; )
        if ((r3 <<= 1) < 0)
    ...
    if (e3 >= this.length || 0 === this.groupSizes[e3])
      return t2;
    for (var n2 = this.groupSizes[e3], o2 = this.indexOfGroup(e3), r3 = o2 + n2, s3 = o2; s3 < r3; s3++)
...
var Ne = function(e2, t2, n2) {
  for (var o2, r3 = n2.split(","), s3 = 0, i3 = r3.length; s3 < i3; s3++)
    (o2 = r3[s3]) && e2.registerName(t2, o2);
};
var Pe = function(e2, t2) {
  for (var n2, o2 = (null !== (n2 = t2.textContent) && void 0 !== n2 ? n2 : "").split(g), r3 = [], s3 = 0, i3 = o2.length; s3 < i3; s3++) {
    var a3 = o2[s3].trim();
    if (a3) {
      var c3 = a3.match(Ee);
      if (c3) {
...
var Ie = function(e2) {
  var t2 = document.head, n2 = e2 || t2, o2 = document.createElement("style"), r3 = function(e3) {
    var t3 = Array.from(e3.querySelectorAll("style[".concat(f, "]")));
    return t3[t3.length - 1];
  }(n2), s3 = void 0 !== r3 ? r3.nextSibling : null;
  o2.setAttribute(f, m), o2.setAttribute(y, v);
  var i3 = Ce();
  return i3 && o2.setAttribute("nonce", i3), n2.insertBefore(o2, s3), o2;
};
var Ae = function() {
  function e2(e3) {
...
var ke = function() {
  function e2(e3, n2, o2) {
    ...
    this.options = __assign(__assign({}, Te), e3), this.gs = n2, this.names = new Map(o2), this.server = !!e3.isServer, !this.server && S && Re && (Re = false, _e(this)), ue(this, function() {
      return function(e4) {
        for (var t2 = e4.getTag(), n3 = t2.length, o3 = "", r4 = function(n4) {
          var r5 = function(e5) {
            return ve.get(e5);
          }(n4);
          if (void 0 === r5)
          ...
          }), o3 += "".concat(i3).concat(a3, '{content:"').concat(c3, '"}').concat(g);
        }, s3 = 0; s3 < n3; s3++)
          r4(s3);
        return o3;
      }(r3);
...
function Fe(e2) {
  var t2, n2, o2, r3 = void 0 === e2 ? C : e2, s3 = r3.options, i3 = void 0 === s3 ? C : s3, a3 = r3.plugins, c3 = void 0 === a3 ? _ : a3, l3 = function(e3, o3, r4) {
    return r4.startsWith(n2) && r4.endsWith(n2) && r4.replaceAll(n2, "").length > 0 ? ".".concat(t2) : e3;
  }, u3 = c3.slice();
  u3.push(function(e3) {
    e3.type === RULESET && e3.value.includes("&") && (e3.props[0] = e3.props[0].replace(je, n2).replace(o2, l3));
  }), i3.prefix && u3.push(prefixer), u3.push(stringify);
  var p3 = function(e3, r4, s4, a4) {
    void 0 === r4 && (r4 = ""), void 0 === s4 && (s4 = ""), void 0 === a4 && (a4 = "&"), t2 = a4, n2 = r4, o2 = new RegExp("\\".concat(n2, "\\b"), "g");
...
var Je = function(t2) {
  ...
  for (var s3 in t2) {
    var i3 = t2[s3];
    t2.hasOwnProperty(s3) && !Ue(i3) && (Array.isArray(i3) && i3.isCss || re(i3) ? r3.push("".concat(He(s3), ":"), i3, ";") : ce(i3) ? r3.push.apply(r3, __spreadArray(__spreadArray(["".concat(s3, " {")], Je(i3), false), ["}"], false)) : r3.push("".concat(He(s3), ": ").concat((n2 = s3, null == (o2 = i3) || "boolean" == typeof o2 || "" === o2 ? "" : "number" != typeof o2 || 0 === o2 || n2 in unitlessKeys || n2.startsWith("--") ? String(o2).trim() : "".concat(o2, "px")), ";")));
  }
  return r3;
};
function Xe(e2, t2, n2, o2) {
  ...
  if (re(e2)) {
    if (!re(s3 = e2) || s3.prototype && s3.prototype.isReactComponent || !t2)
      return [e2];
    var r3 = e2(t2);
    return "object" != typeof r3 || Array.isArray(r3) || r3 instanceof We || ce(r3) || null === r3 || console.error("".concat(B(e2), " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details.")), Xe(r3, t2, n2, o2);
  }
  var s3;
...
var Qe = function() {
  ...
  return e2.prototype.generateAndInjectStyles = function(e3, t2, n2) {
    ...
    if (this.isStatic && !n2.hash)
      ...
      if (c3) {
        var d2 = x(a3 >>> 0);
        t2.hasNameForId(this.componentId, d2) || t2.insertRules(this.componentId, d2, n2(c3, ".".concat(d2), void 0, this.componentId)), o2 = ie(o2, d2);
      }
    }
    return o2;
  }, e2;
...
function it(e2, r3, s3) {
  ...
  }(e2) : m3, g3 = r3.displayName && r3.componentId ? "".concat(R(r3.displayName), "-").concat(r3.componentId) : r3.componentId || f3, S2 = i3 && a3.attrs ? a3.attrs.concat(d2).filter(Boolean) : d2, w3 = r3.shouldForwardProp;
  ...
  var N2 = new Qe(s3, g3, i3 ? a3.componentStyle : void 0);
  function O2(e3, r4) {
    return function(e4, r5, s4) {
      var i4 = e4.attrs, a4 = e4.componentStyle, c4 = e4.defaultProps, p4 = e4.foldedComponentIds, d3 = e4.styledComponentId, h3 = e4.target, f4 = import_react.default.useContext(et), m4 = Ge(), y4 = e4.shouldForwardProp || m4.shouldForwardProp;
      (0, import_react.useDebugValue)(d3);
      var v3 = I(r5, f4, c4) || C, g4 = function(e5, n2, o2) {
        for (var r6, s5 = __assign(__assign({}, n2), { className: void 0, theme: o2 }), i5 = 0; i5 < e5.length; i5 += 1) {
      ...
      var N3 = ie(p4, d3);
      return E3 && (N3 += " " + E3), g4.className && (N3 += " " + g4.className), w4[L(S3) && !A.has(S3) ? "class" : "className"] = N3, s4 && (w4.ref = s4), (0, import_react.createElement)(S3, w4);
    }(D2, e3, r4);
  }
  O2.displayName = y3;
  var D2 = import_react.default.forwardRef(O2);
  return D2.attrs = S2, D2.componentStyle = N2, D2.displayName = y3, D2.shouldForwardProp = w3, D2.foldedComponentIds = i3 ? ie(a3.foldedComponentIds, a3.styledComponentId) : "", D2.styledComponentId = g3, D2.target = i3 ? a3.target : e2, Object.defineProperty(D2, "defaultProps", { get: function() {
  ...
  } }), P(y3, g3), D2.warnTooManyClasses = function(e3, t2) {
    var n2 = {}, o2 = false;
    return function(r4) {
...
function at(e2, t2) {
  for (var n2 = [e2[0]], o2 = 0, r3 = t2.length; o2 < r3; o2 += 1)
...
function ut(n2, o2, r3) {
  ...
  var s3 = function(t2) {
    ...
    return n2(o2, r3, lt.apply(void 0, __spreadArray([t2], s4, false)));
  };
  return s3.attrs = function(e2) {
    return ut(n2, o2, __assign(__assign({}, r3), { attrs: Array.prototype.concat(r3.attrs, e2).filter(Boolean) }));
  }, s3.withConfig = function(e2) {
    return ut(n2, o2, __assign(__assign({}, r3), e2));
  }, s3;
}
var pt = function(e2) {
  return ut(it, e2);
...
var ht = function() {
  ...
  return e2.prototype.createStyles = function(e3, t2, n2, o2) {
    var r3 = o2(ae(Xe(this.rules, t2, n2, o2)), ""), s3 = this.componentId + e3;
...
// node_modules/react-image-color-picker/dist/index.esm.js
function r2(n2, t2, e2, i3) {
  return new (e2 || (e2 = Promise))(function(o2, r3) {
    function a3(n3) {
      try {
        s3(i3.next(n3));
      } catch (n4) {
    ...
    s3((i3 = i3.apply(n2, t2 || [])).next());
  });
}
function a2(n2, t2) {
  var e2, i3, o2, r3, a3 = { label: 0, sent: function() {
    if (1 & o2[0])
      throw o2[1];
    return o2[1];
  }, trys: [], ops: [] };
  return r3 = { next: c3(0), throw: c3(1), return: c3(2) }, "function" == typeof Symbol && (r3[Symbol.iterator] = function() {
    return this;
  }), r3;
  function c3(c4) {
    return function(s3) {
      return function(c5) {
        ...
        for (; r3 && (r3 = 0, c5[0] && (a3 = 0)), a3; )
          try {
            if (e2 = 1, i3 && (o2 = 2 & c5[0] ? i3.return : c5[0] ? i3.throw || ((o2 = i3.return) && o2.call(i3), 0) : i3.next) && !(o2 = o2.call(i3, c5[1])).done)
              return o2;
            switch (i3 = 0, o2 && (c5 = [2 & c5[0], o2.value]), c5[0]) {
              case 0:
              case 1:
                o2 = c5;
                break;
              ...
              case 5:
                a3.label++, i3 = c5[1], c5 = [0];
                continue;
              case 7:
                c5 = a3.ops.pop(), a3.trys.pop();
                continue;
              default:
                if (!(o2 = a3.trys, (o2 = o2.length > 0 && o2[o2.length - 1]) || 6 !== c5[0] && 2 !== c5[0])) {
                  a3 = 0;
                  continue;
                }
                if (3 === c5[0] && (!o2 || c5[1] > o2[0] && c5[1] < o2[3])) {
                  a3.label = c5[1];
                  break;
                }
                if (6 === c5[0] && a3.label < o2[1]) {
                  a3.label = o2[1], o2 = c5;
                  break;
                }
                if (o2 && a3.label < o2[2]) {
                  a3.label = o2[2], a3.ops.push(c5);
                  break;
                }
...
function c2(n2, t2) {
  var e2 = "function" == typeof Symbol && n2[Symbol.iterator];
  if (!e2)
    return n2;
  var i3, o2, r3 = e2.call(n2), a3 = [];
  try {
    for (; (void 0 === t2 || t2-- > 0) && !(i3 = r3.next()).done; )
      a3.push(i3.value);
  } catch (n3) {
    o2 = { error: n3 };
  } finally {
    try {
      i3 && !i3.done && (e2 = r3.return) && e2.call(r3);
    } finally {
      if (o2)
        throw o2.error;
    }
...
var u2;
var d;
var h = dt.div(l2 || (l2 = s2(["\n  position: absolute;\n  top: 10px;\n  right: 10px;\n  width: 40px;\n  height: 40px;\n  border-radius: 10px;\n  border: 3px solid white;\n  z-index: 100;\n\n  @media (max-width: 768px) {\n    width: 30px;\n    height: 30px;\n  }\n"], ["\n  position: absolute;\n  top: 10px;\n  right: 10px;\n  width: 40px;\n  height: 40px;\n  border-radius: 10px;\n  border: 3px solid white;\n  z-index: 100;\n\n  @media (max-width: 768px) {\n    width: 30px;\n    height: 30px;\n  }\n"])));
var p2 = function(t2) {
  var e2 = t2.color;
  return import_react2.default.createElement(h, { "data-testid": "color-preview", style: { backgroundColor: e2 } });
};
var f2 = dt.div(u2 || (u2 = s2(["\n  position: absolute;\n  top: 10px;\n  left: 10px;\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  z-index: 100;\n"], ["\n  position: absolute;\n  top: 10px;\n  left: 10px;\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  z-index: 100;\n"])));
var v2 = dt.div(d || (d = s2(["\n  width: 100px;\n  height: 100px;\n  box-shadow: 1px 1px 1px #000;\n  border: 4px solid red;\n  border-radius: 50%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  @media (max-width: 768px) {\n    width: 60px;\n    height: 60px;\n  }\n"], ["\n  width: 100px;\n  height: 100px;\n  box-shadow: 1px 1px 1px #000;\n  border: 4px solid red;\n  border-radius: 50%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  @media (max-width: 768px) {\n    width: 60px;\n    height: 60px;\n  }\n"])));
var x2 = function() {
  function n2(n3) {
    this.canvas = n3, this.context = this.canvas.getContext("2d", { willReadFrequently: true });
  }
  return n2.prototype.listenMovements = function(n3) {
    this.canvas.addEventListener("touchmove", n3), this.canvas.addEventListener("pointermove", n3);
  }, n2.prototype.cleanUp = function(n3) {
    this.canvas.removeEventListener("touchmove", n3), this.canvas.addEventListener("pointermove", n3);
  }, n2.prototype.drawImage = function(n3) {
    this.context.drawImage(n3, 0, 0);
  }, n2.prototype.setDimensions = function(n3, t2) {
    this.canvas.width = n3, this.canvas.height = t2;
  }, n2.prototype.getDimensions = function() {
    return { width: this.canvas.width, height: this.canvas.height };
  }, n2.prototype.getCanvasCenterPoint = function() {
    return { x: this.canvas.width / 2, y: this.canvas.height / 2 };
  }, n2.prototype.getCanvasCoordinates = function(n3) {
    var t2 = this.canvas.getBoundingClientRect(), e2 = this.canvas.width / t2.width, i3 = this.canvas.height / t2.height;
    return { x: (n3.x - t2.left) * e2, y: (n3.y - t2.top) * i3 };
  }, n2.prototype.getPixelColor = function(n3) {
    var t2 = this.context.getImageData(n3.x, n3.y, 1, 1).data;
    if (t2.length < 4)
      return "rgb(0,0,0)";
    var e2 = c2(t2, 3), i3 = e2[0], o2 = e2[1], r3 = e2[2];
    return "rgb(".concat(i3, ", ").concat(o2, ", ").concat(r3, ")");
  }, n2;
}();
var m2;
var g2;
var w2 = function(t2) {
  var o2 = t2.color, r3 = t2.coordinates, a3 = t2.dimensions, s3 = t2.image, l3 = t2.zoom, u3 = void 0 === l3 ? 0.5 : l3, d2 = function() {
    var n2 = c2((0, import_react2.useState)(true), 2), t3 = n2[0], o3 = n2[1];
    return (0, import_react2.useEffect)(function() {
      if ("undefined" != typeof window) {
        var n3 = window.matchMedia("(max-width: 768px)");
        o3(n3.matches);
        var t4 = function(n4) {
          o3(n4.matches);
        };
        return n3.addEventListener("change", t4), function() {
          n3.removeEventListener("change", t4);
        };
      }
    }, []), t3;
  }(), h2 = r3.x, p3 = r3.y, x3 = u3, m3 = d2 ? 30 : 50, g3 = a3.width * x3, w3 = a3.height * x3, y3 = h2 * x3 - m3, b2 = p3 * x3 - m3;
  return import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement(f2, { "data-testid": "zoom-preview-container" }, import_react2.default.createElement(v2, { "data-testid": "zoom-preview", style: { backgroundSize: "".concat(g3, "px ").concat(w3, "px"), backgroundImage: "url(".concat(s3, ")"), backgroundRepeat: "no-repeat", backgroundPosition: "-".concat(y3, "px -").concat(b2, "px"), borderColor: o2 } })));
};
var y2 = dt.canvas(m2 || (m2 = s2(["\n  position: relative;\n  width: 100%;\n  height: 100%;\n  top: 0;\n  left: 0;\n  z-index: 50;\n  touch-action: none;\n  object-fit: cover;\n"], ["\n  position: relative;\n  width: 100%;\n  height: 100%;\n  top: 0;\n  left: 0;\n  z-index: 50;\n  touch-action: none;\n  object-fit: cover;\n"])));
var b = dt.div(g2 || (g2 = s2(["\n  position: relative;\n  display: flex;\n  width: 100%;\n  height: 100%;\n"], ["\n  position: relative;\n  display: flex;\n  width: 100%;\n  height: 100%;\n"])));
var C2 = function(o2) {
  var s3 = o2.onColorPick, l3 = o2.imgSrc, u3 = o2.zoom, d2 = (0, import_react2.useRef)(null), h2 = function(n2, o3) {
    var s4, l4, u4 = (0, import_react2.useRef)(null), d3 = c2((0, import_react2.useState)("tranparent"), 2), h3 = d3[0], p3 = d3[1], f4 = c2((0, import_react2.useState)({ x: 0, y: 0 }), 2), v4 = f4[0], m4 = f4[1], g3 = function(n3) {
      n3.preventDefault();
      var t2 = "touches" in n3 ? n3.touches[0] : n3, e2 = { x: t2.clientX, y: t2.clientY }, i3 = u4.current, o4 = i3.getCanvasCoordinates(e2), r3 = i3.getPixelColor(o4);
      p3(r3), m4(o4);
    };
    return (0, import_react2.useEffect)(function() {
      null === u4.current && (u4.current = new x2(n2.current), u4.current.listenMovements(g3));
      var t2 = u4.current;
      return function() {
        r2(this, void 0, void 0, function() {
          var n3, e2, i3;
          return a2(this, function(c3) {
            switch (c3.label) {
              case 0:
                return [4, (s5 = o3, r2(void 0, void 0, void 0, function() {
                  return a2(this, function(n4) {
                    return [2, new Promise(function(n5) {
                      var t3 = new Image();
                      t3.crossOrigin = "Anonymous", t3.onload = function() {
                        return n5(t3);
                      }, t3.src = s5;
                    })];
                  });
              ...
              case 1:
                return n3 = c3.sent(), t2.setDimensions(n3.width, n3.height), t2.drawImage(n3), e2 = t2.getCanvasCenterPoint(), i3 = t2.getPixelColor(e2), p3(i3), m4(e2), [2];
            }
            var s5;
          });
        });
    ...
    }, [o3]), { color: h3, coordinates: v4, dimensions: null !== (l4 = null === (s4 = u4.current) || void 0 === s4 ? void 0 : s4.getDimensions()) && void 0 !== l4 ? l4 : { width: 0, height: 0 } };
  }(d2, l3), f3 = h2.color, v3 = h2.coordinates, m3 = h2.dimensions;
  return import_react2.default.createElement(b, { "data-testid": "image-color-pick-container" }, import_react2.default.createElement(p2, { color: f3 }), import_react2.default.createElement(w2, { zoom: u3, color: f3, coordinates: v3, dimensions: m3, image: l3 }), import_react2.default.createElement(y2, { "data-testid": "image-color-pick-canvas", id: "image-color-pick-canvas", ref: d2, onClick: function() {
    return s3(f3);
  }, onTouchEnd: function() {
    return s3(f3);
  } }));
...
export {
  C2 as ImageColorPicker
};
//# sourceMappingURL=react-image-color-picker.js.map
