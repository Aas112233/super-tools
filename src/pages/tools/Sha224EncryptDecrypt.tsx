...
export const Sha224EncryptDecrypt: React.FC = () => {
  ...
  const handleHash = () => {
    ...
    if (input.trim()) {
      setOutput('SHA224 hash will appear here...');
    } else {
      setOutput('');
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-cyan-500 to-teal-500 bg-clip-text text-transparent mb-4">
            SHA224 Encrypt/Decrypt
          </h1>
          <p className="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
            Generate SHA224 hash values for your text. Note: SHA224 is a one-way hash function and cannot be decrypted.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6 md:p-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  placeholder="Enter text to hash with SHA224..."
                  className="w-full h-32 p-4 border-2 border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 focus:border-cyan-400 focus:outline-none resize-none"
                />
              </div>
            </div>
            ...
            {/* Output Section */}
            <div>
              <h2 className="text-xl font-semibold mb-4 text-slate-800 dark:text-slate-200">SHA224 Hash</h2>
              <div className="relative">
                <textarea
                  value={output}
                  readOnly
                  placeholder="SHA224 hash will appear here..."
          ...
          <div className="mt-6 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl">
            ...
            <p className="text-amber-700 dark:text-amber-300 text-sm">
              SHA224 is part of the SHA-2 family of cryptographic hash functions that produces a 224-bit (28-byte) hash value. It's more secure than SHA1 and MD5. SHA224 is a one-way function, meaning it cannot be "decrypted".
            </p>
          </div>
        </div>
      </div>
