...
const TOOLS_REGISTRY: Record<string, Tool> = {
  'barcode-generator': { id: 'barcode-generator', name: 'Barcode Generator', href: '/tools/barcode-generator' },
  'base64-encoder-decoder': { id: 'base64-encoder-decoder', name: 'Base64 Encoder Decoder', href: '/tools/base64-encoder-decoder' },
  'bionic-text-converter': { id: 'bionic-text-converter', name: 'Bionic Text Converter', href: '/tools/bionic-text-converter' },
  'bionic-reading-converter': { id: 'bionic-reading-converter', name: 'Bionic Reading Converter', href: '/tools/bionic-reading-converter' },
  'bulk-barcode-qr-generator': { id: 'bulk-barcode-qr-generator', name: 'Bulk Barcode QR Generator', href: '/tools/bulk-barcode-qr-generator' },
  'case-converter': { id: 'case-converter', name: 'Case Converter', href: '/tools/case-converter' },
  'rich-text-editor': { id: 'rich-text-editor', name: 'Rich Text Editor', href: '/tools/rich-text-editor' },
  'chart-exporter': { id: 'chart-exporter', name: 'Chart Exporter', href: '/tools/chart-exporter' },
  'code-to-image-converter': { id: 'code-to-image-converter', name: 'Code To Image Converter', href: '/tools/code-to-image-converter' },
  'color-prism': { id: 'color-prism', name: 'Color Prism', href: '/tools/color-prism' },
  ...
  'css-border-radius-generator': { id: 'css-border-radius-generator', name: 'CSS Border Radius Generator', href: '/tools/css-border-radius-generator' },
  ...
  'echarts-integration': { id: 'echarts-integration', name: 'ECharts Integration', href: '/tools/echarts-integration' },
  'font-pairing-finder': { id: 'font-pairing-finder', name: 'Font Pairing Finder', href: '/tools/font-pairing-finder' },
  'graphics-editor': { id: 'graphics-editor', name: 'Graphics Editor', href: '/tools/graphics-editor' },
  'handwriting-generator': { id: 'handwriting-generator', name: 'Handwriting Generator', href: '/tools/handwriting-generator' },
  ...
  'image-to-pdf': { id: 'image-to-pdf', name: 'Image To PDF', href: '/tools/image-to-pdf' },
  'image-trimmer': { id: 'image-trimmer', name: 'Image Trimmer', href: '/tools/image-trimmer' },
  'background-remover': { id: 'background-remover', name: 'Background Remover', href: '/tools/background-remover' },
  'instagram-filters': { id: 'instagram-filters', name: 'Instagram Filters', href: '/tools/instagram-filters' },
  'instagram-photo-downloader': { id: 'instagram-photo-downloader', name: 'Instagram Photo Downloader', href: '/tools/instagram-photo-downloader' },
  'instagram-post-generator': { id: 'instagram-post-generator', name: 'Instagram Post Generator', href: '/tools/instagram-post-generator' },
  ...
  'list-randomizer': { id: 'list-randomizer', name: 'List Randomizer', href: '/tools/list-randomizer' },
  'lorem-ipsum-generator': { id: 'lorem-ipsum-generator', name: 'Lorem Ipsum Generator', href: '/tools/lorem-ipsum-generator' },
  'md5-encrypt-decrypt': { id: 'md5-encrypt-decrypt', name: 'MD5 Encrypt Decrypt', href: '/tools/md5-encrypt-decrypt' },
  'pdf-add-page-numbers': { id: 'pdf-add-page-numbers', name: 'PDF Add Page Numbers', href: '/tools/pdf-add-page-numbers' },
  'pdf-add-watermark': { id: 'pdf-add-watermark', name: 'PDF Add Watermark', href: '/tools/pdf-add-watermark' },
  'pdf-compress': { id: 'pdf-compress', name: 'PDF Compress', href: '/tools/pdf-compress' },
  'pdf-crop': { id: 'pdf-crop', name: 'PDF Crop', href: '/tools/pdf-crop' },
  'pdf-extract-pages': { id: 'pdf-extract-pages', name: 'PDF Extract Pages', href: '/tools/pdf-extract-pages' },
  'pdf-merge': { id: 'pdf-merge', name: 'PDF Merge', href: '/tools/pdf-merge' },
  'pdf-metadata': { id: 'pdf-metadata', name: 'PDF Metadata', href: '/tools/pdf-metadata' },
  'pdf-password': { id: 'pdf-password', name: 'PDF Password', href: '/tools/pdf-password' },
  'pdf-rotate': { id: 'pdf-rotate', name: 'PDF Rotate', href: '/tools/pdf-rotate' },
  'pdf-split': { id: 'pdf-split', name: 'PDF Split', href: '/tools/pdf-split' },
  'pdf-to-image': { id: 'pdf-to-image', name: 'PDF To Image', href: '/tools/pdf-to-image' },
  'pdf-to-word': { id: 'pdf-to-word', name: 'PDF To Word', href: '/tools/pdf-to-word' },
  'photo-filters': { id: 'photo-filters', name: 'Photo Filters', href: '/tools/photo-filters' },
  'qrcode-generator': { id: 'qrcode-generator', name: 'QR Code Generator', href: '/tools/qrcode-generator' },
  'react-native-shadow-generator': { id: 'react-native-shadow-generator', name: 'React Native Shadow Generator', href: '/tools/react-native-shadow-generator' },
  'sha1-encrypt-decrypt': { id: 'sha1-encrypt-decrypt', name: 'SHA1 Encrypt Decrypt', href: '/tools/sha1-encrypt-decrypt' },
  'sha224-encrypt-decrypt': { id: 'sha224-encrypt-decrypt', name: 'SHA224 Encrypt Decrypt', href: '/tools/sha224-encrypt-decrypt' },
  'sha256-encrypt-decrypt': { id: 'sha256-encrypt-decrypt', name: 'SHA256 Encrypt Decrypt', href: '/tools/sha256-encrypt-decrypt' },
  'sha384-encrypt-decrypt': { id: 'sha384-encrypt-decrypt', name: 'SHA384 Encrypt Decrypt', href: '/tools/sha384-encrypt-decrypt' },
  'sha512-encrypt-decrypt': { id: 'sha512-encrypt-decrypt', name: 'SHA512 Encrypt Decrypt', href: '/tools/sha512-encrypt-decrypt' },
  'strong-random-password-generator': { id: 'strong-random-password-generator', name: 'Strong Random Password Generator', href: '/tools/strong-random-password-generator' },
  ...
  'color-prism-handwriting-converter': { id: 'color-prism-handwriting-converter', name: 'Color Prism Handwriting Converter', href: '/tools/color-prism-handwriting-converter' },
  'url-encoder-decoder': { id: 'url-encoder-decoder', name: 'URL Encoder Decoder', href: '/tools/url-encoder-decoder' },
  'url-slug-generator': { id: 'url-slug-generator', name: 'URL Slug Generator', href: '/tools/url-slug-generator' },
  'whitespace-cleaner': { id: 'whitespace-cleaner', name: 'Whitespace Cleaner', href: '/tools/whitespace-cleaner' }
};
...
const categories: Category[] = [
  ...
  },
  {
    ...
    tools: [
      TOOLS_REGISTRY['rich-text-editor'],
      TOOLS_REGISTRY['bionic-text-converter'],
      TOOLS_REGISTRY['bionic-reading-converter'],
      TOOLS_REGISTRY['case-converter'],
      TOOLS_REGISTRY['font-pairing-finder'],
      TOOLS_REGISTRY['handwriting-generator'],
      TOOLS_REGISTRY['letter-counter'],
      TOOLS_REGISTRY['lorem-ipsum-generator'],
      TOOLS_REGISTRY['text-to-handwriting-converter'],
      TOOLS_REGISTRY['color-prism-handwriting-converter'],
      TOOLS_REGISTRY['whitespace-cleaner']
    ]
  },
  {
    id: 'color-tools',
  ...
  },
  {
    ...
    tools: [
      ...
      TOOLS_REGISTRY['image-to-pdf'],
      TOOLS_REGISTRY['image-trimmer'],
      TOOLS_REGISTRY['background-remover'],
      TOOLS_REGISTRY['photo-filters']
    ]
  },
  {
    id: 'css-tools',
    ...
    tools: [
      ...
      TOOLS_REGISTRY['css-border-radius-generator'],
  ...
  },
  {
    ...
    tools: [
      TOOLS_REGISTRY['pdf-add-page-numbers'],
      TOOLS_REGISTRY['pdf-add-watermark'],
      TOOLS_REGISTRY['pdf-compress'],
      TOOLS_REGISTRY['pdf-crop'],
      TOOLS_REGISTRY['pdf-extract-pages'],
      TOOLS_REGISTRY['pdf-merge'],
      TOOLS_REGISTRY['pdf-metadata'],
      TOOLS_REGISTRY['pdf-password'],
      TOOLS_REGISTRY['pdf-rotate'],
      TOOLS_REGISTRY['pdf-split'],
      TOOLS_REGISTRY['pdf-to-image'],
      TOOLS_REGISTRY['pdf-to-word']
    ]
  },
  {
    id: 'social-tools',
  ...
  },
  {
    ...
    tools: [
      ...
      TOOLS_REGISTRY['echarts-integration'],
      TOOLS_REGISTRY['graphics-editor'],
      TOOLS_REGISTRY['list-randomizer'],
      TOOLS_REGISTRY['qrcode-generator'],
